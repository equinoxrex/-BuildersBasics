...
def createFiles(type, name):
    ...
    try:
        if(type == "cube"):
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{name}.json", write) as file:
                json.dump({"variants": {"": { "model": f"{setup.modID}:block/{name}" }}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}.json", write) as file:
                json.dump({"parent": "block/cube_all","textures": {"all": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{name}.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{name}.json", write) as file:
                json.dump({"variants": {"axis=y":  { "model": f"{setup.modID}:block/{name}" },"axis=z":   { "model": f"{setup.modID}:block/{name}_horizontal", "x": 90 },"axis=x":   { "model": f"{setup.modID}:block/{name}_horizontal", "x": 90, "y": 90 }}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}.json", write) as file:
                json.dump({"parent": "block/cube_column","textures": {"end": f"{setup.modID}:block/{name}_top","side": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_horizontal.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_vertical.json", write) as file:
            ...
            if(not optionCollectionWood.get()):
                with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_slab.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_slab.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_slab_top.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_slab.json", write) as file:
                    json.dump({"parent": f"{setup.modID}:block/{depluralize(name)}_slab"}, file, indent = 4)
            else:
                with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_slab.json", write) as file:
                    json.dump({"variants": {"type=bottom": {"model": f"{setup.modID}:block/{depluralize(name)}_slab"},"type=top": {"model": f"{setup.modID}:block/{depluralize(name)}_slab_top"},"type=double": {"model": f"{setup.modID}:block/{name}_planks"}}}, file, indent = 4)
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_slab.json", write) as file:
                    json.dump({"parent": "block/slab","textures": {"bottom": f"{setup.modID}:block/{name}_planks", "top": f"{setup.modID}:block/{name}_planks","side": f"{setup.modID}:block/{name}_planks"}}, file, indent = 4)
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_slab_top.json", write) as file:
                    json.dump({"parent": "block/slab_top","textures": {"bottom": f"{setup.modID}:block/{name}_planks", "top": f"{setup.modID}:block/{name}_planks","side": f"{setup.modID}:block/{name}_planks"}}, file, indent = 4)
                with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_slab.json", write) as file:
                    json.dump({"parent": f"{setup.modID}:block/{depluralize(name)}_slab"}, file, indent = 4)
        elif(type == "stairs"):
            if(not optionCollectionWood.get()):
                with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_stairs.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_stairs.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_stairs_inner.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_stairs_outer.json", write) as file:
                ...
                with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_stairs.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_wall.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_wall_inventory.json", write) as file:
                json.dump({"parent": "block/wall_inventory","textures": {"wall": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_wall_post.json", write) as file:
                json.dump({"parent": "block/template_wall_post","textures": {"wall": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_wall_side.json", write) as file:
                json.dump({"parent": "block/template_wall_side","textures": {"wall": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_wall.json", write) as file:
                json.dump({"parent": f"{setup.modID}:block/{depluralize(name)}_wall_inventory"}, file, indent = 4)
        elif(type == "fences"):
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_fence.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{depluralize(name)}_fence_gate.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_gate.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_gate_open.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_gate_wall.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_gate_wall_open.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_inventory.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_post.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{depluralize(name)}_fence_side.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_fence_gate.json", write) as file:
                json.dump({"parent": f"{setup.modID}:block/{name}_fence_gate"}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{depluralize(name)}_fence.json", write) as file:
                json.dump({"parent": f"{setup.modID}:block/{name}_fence_inventory"}, file, indent = 4)
        elif(type == "panes"):
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{name}_pane.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_pane_noside.json", write) as file:
                json.dump({"parent": "block/template_glass_pane_noside","textures": {"pane": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_pane_noside_alt.json", write) as file:
                json.dump({"parent": "block/template_glass_pane_noside_alt","textures": {"pane": f"{setup.modID}:block/{name}"}}, file, indent = 4)
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_pane_post.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_pane_side.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_pane_side_alt.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{name}_pane.json", write) as file:
                json.dump({"parent": "item/generated","textures": {"layer0": f"{setup.modID}:item/{name}"}}, file, indent = 4)
        elif(type == "buttons"):
            with open(f"{setup.path}/assets/{setup.modID}/blockstates/{name}_button.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_button.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_button_pressed.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/block/{name}_button_inventory.json", write) as file:
            ...
            with open(f"{setup.path}/assets/{setup.modID}/models/item/{name}_button.json", write) as file:
