...
public class ModBlocks {
    ...
    public static Block FIREBRAND = new FirebrandBlock(Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F).sound(SoundType.WOOD)).setRegistryName("firebrand");
