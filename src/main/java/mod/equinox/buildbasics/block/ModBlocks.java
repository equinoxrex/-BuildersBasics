...
public class ModBlocks {
    ...
    public static Block TERRACOTTA_BRICK_STAIRS = new StairsBlock(() -> TERRACOTTA_BRICKS.getDefaultState(), Block.Properties.create(Material.ROCK, MaterialColor.ADOBE).hardnessAndResistance(1.25F, 4.2F)).setRegistryName("terracotta_bricks");
