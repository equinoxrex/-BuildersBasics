...
public class ModBlocks {
    ...
    public static Block FIREBRAND = new FirebrandBlock(Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.0F).sound(SoundType.WOOD).lightValue(14)).setRegistryName("firebrand");
    ...
    public static Block ROTTEN_JUNGLE_PLANKS = new RottenBlock(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(1.0F, 1.5F).sound(SoundType.WOOD)).setRegistryName("rotten_jungle_planks");
    public static Block ROTTEN_ACACIA_PLANKS = new RottenBlock(Block.Properties.create(Material.WOOD, MaterialColor.ADOBE).hardnessAndResistance(1.0F, 1.5F).sound(SoundType.WOOD)).setRegistryName("rotten_acacia_planks");
    public static Block ROTTEN_DARK_OAK_PLANKS = new RottenBlock(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(1.0F, 1.5F).sound(SoundType.WOOD)).setRegistryName("rotten_dark_oak_planks");
    public static Block MOSSY_OAK_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F, 2.5F).sound(SoundType.WOOD)).setRegistryName("mossy_oak_planks");
    public static Block MOSSY_SPRUCE_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F, 2.5F).sound(SoundType.WOOD)).setRegistryName("mossy_spruce_planks");
    public static Block MOSSY_BIRCH_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.SAND).hardnessAndResistance(2.0F, 2.5F).sound(SoundType.WOOD)).setRegistryName("mossy_birch_planks");
    public static Block MOSSY_JUNGLE_PLANKS = new Block(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(2.0F, 2.5F).sound(SoundType.WOOD)).setRegistryName("mossy_jungle_planks");
    ...
    public static Block COBBLESTONE_BRICK_STAIRS = new StairsBlock(() -> COBBLESTONE_BRICKS.getDefaultState(), Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("cobblestone_brick_stairs");
    public static Block MOSSY_COBBLESTONE_BRICK_STAIRS = new StairsBlock(() -> MOSSY_COBBLESTONE_BRICKS.getDefaultState(), Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("mossy_cobblestone_brick_stairs");
    ...
    public static Block COBBLESTONE_BRICK_SLAB = new SlabBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("cobblestone_brick_slab");
    public static Block MOSSY_COBBLESTONE_BRICK_SLAB = new SlabBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("mossy_cobblestone_brick_slab");
    ...
    public static Block COBBLESTONE_BRICK_WALL = new WallBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("cobblestone_brick_wall");
    public static Block MOSSY_COBBLESTONE_BRICK_WALL = new WallBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(2F, 6.0F)).setRegistryName("mossy_cobblestone_brick_wall");
